...
import { ChevronsUpDown, Menu, Package2 } from 'lucide-react';
import type { View } from '@/app/(app)/partnerverse/page';
            ...
            <SheetContent side="left" className="sm:max-w-xs">
              <nav className="grid gap-6 text-lg font-medium">
                ...
                >
                  ...
                  <span className="sr-only">NG-Beta</span>
                </a>
                {navigationConfig.map((item) => (
                  <a key={item.id} href={item.href} className="flex items-center gap-4 px-2.5 text-muted-foreground hover:text-foreground">
